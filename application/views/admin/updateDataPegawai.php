            ...
            <div class="card-body">
                ...
                <form method="POST" action="<?= base_url('admin/dataPegawai/updateDataAksi/') ?>" enctype="multipart/form-data">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input name="nik" type="text" class="form-control" value="<?php echo $p->nik?>"  id="basic-icon-default-fullname" aria-describedby="basic-icon-default-fullname2" />
                            </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input name="nama_pegawai" type="text" class="form-control" value="<?php echo $p->nama_pegawai?>" id="basic-icon-default-fullname" aria-describedby="basic-icon-default-fullname2" />
                            </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select name="jenis_kelamin" class="form-select" id="exampleFormControlSelect1" aria-label="Default select example">
                                <option value="<?php echo $p->jenis_kelamin?>" selected><?php echo $p->jenis_kelamin?></option>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select name="jabatan" class="form-select" id="exampleFormControlSelect1" aria-label="Default select example">
                                <option value="<?php echo $p->jabatan?> "><selected><?php echo $p->jabatan?></option>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-10">
                            <input name="tanggal_masuk" class="form-control"  value="<?php echo $p->tanggal_masuk?>" type="date"  id="html5-date-input" />
                        </div>
